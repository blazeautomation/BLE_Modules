...
void sl_button_on_change(const sl_button_t *handle)
{
    ...
    if (SL_SIMPLE_BUTTON_INSTANCE(BUTTON0) == handle)
    {
        if ( sl_button_get_state(handle) == SL_SIMPLE_BUTTON_RELEASED)
        {
            led_turn_on(&sl_led_led1);
            app_log_debug("\n------------0000Button pressed-------\n");
        }
        else if(sl_button_get_state(handle) == SL_SIMPLE_BUTTON_PRESSED)
        {
            led_turn_off(&sl_led_led1);
            app_log_debug("\n------------0000Button released-------\n");
        }
    }
    if (SL_SIMPLE_BUTTON_INSTANCE(BUTTON3) == handle)
    {
        if ( sl_button_get_state(handle) == SL_SIMPLE_BUTTON_RELEASED)
        {
            led_turn_on(&sl_led_led2);
            app_log_debug("\n------------333Button pressed-------\n");
        }
        else if(sl_button_get_state(handle) == SL_SIMPLE_BUTTON_PRESSED)
        {
            led_turn_off(&sl_led_led2);
            app_log_debug("\n------------333Button released-------\n");
        }
    }
    if (SL_SIMPLE_BUTTON_INSTANCE(BUTTON2) == handle)
    {
        if ( sl_button_get_state(handle) == SL_SIMPLE_BUTTON_RELEASED)
        {
            led_turn_on(&sl_led_led3);
            app_log_debug("\n------------222Button pressed-------\n");
        }
        else if(sl_button_get_state(handle) == SL_SIMPLE_BUTTON_PRESSED)
        {
            led_turn_off(&sl_led_led3);
            app_log_debug("\n------------222Button released-------\n");
        }
    }
}
